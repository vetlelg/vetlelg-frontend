const About = () => (
    <div id="about" className="row pt-5">
        ...
        <p className="pt-4">
            I'm a Software Engineering student with a background as an IT Technician, set to complete my Bachelor's degree in Spring 2025.
        </p>
        <p>
        ...
        <p>
            I love tackling complex challenges and continuously expanding my skill set. I am actively seeking opportunities to contribute and grow professionally.
        </p>
